...
class Pipeline():
    def __init__(self, link_to_data_files, link_to_output):
        self.link_to_data_files = link_to_data_files
        self.link_to_output = link_to_output
    ...
    def query_from_db(self):
        link_pseudo_query = r"C:\Users\Admin\Downloads\DE 2nd folder\DE project\scrape component\data cb\cleansed data cb"
        print("Query df_companies_sv from server:")
        df_companies_sv = pd.read_csv(os.path.join(link_pseudo_query, r"companies.csv"),
        ...
        df_job_id = pd.read_csv(os.path.join(link_pseudo_query, r"jobs.csv"),
        ...
        df_ordered_cap_bac = pd.read_csv(os.path.join(link_pseudo_query, r"ordered_cap_bac.csv"),
        ...
        df_city = pd.read_csv(os.path.join(link_pseudo_query, r"city_country.csv"),
        ...
        return df_companies_sv, df_job_id, df_ordered_cap_bac, cap_bac, df_city
    ...
    def processing_raw_data(self):
        ...
        try:
            ...
            df_companies_sv, df_job_id, df_ordered_cap_bac, cap_bac, df_city = self.query_from_db()

            print("1) Processing raw data")
            print()

            lst_data_files = os.listdir(self.link_to_data_files)
            ...
            df = pd.DataFrame()
            for data_file in lst_data_files:
                sub_df = pd.read_csv(os.path.join(self.link_to_data_files, data_file))
            ...
            if len(df):
                ...
                df_jobs_unknown.to_csv(os.path.join(self.link_to_output, r"companies.csv"), index=False)
                print()
                ...
                df_jobs = df_jobs.fillna("Unknown")
                df_jobs.to_csv(os.path.join(self.link_to_output, r"location_job.csv"), index=False)
                print()
                ...
                pd.DataFrame({"City": list(set_unknown_cities), "Country": [np.NaN for i in range(len(list(set_unknown_cities)))]})\
                    .to_csv(os.path.join(self.link_to_output, r"city_country.csv"), index=False)
                print()
                ...
                df_outstanding_welfare.to_csv(os.path.join(self.link_to_output, r"outstanding_welfare_job.csv"), index=False)
                print()
                ...
                df_detailed_welfare.to_csv(os.path.join(self.link_to_output, r"detailed_welfare_job.csv"), index=False)
                print()
                ...
                df_nganh_nghe.to_csv(os.path.join(self.link_to_output, r"nganh_nghe_job.csv"), index=False)
                print()
                ...
                df_job_tags.to_csv(os.path.join(self.link_to_output, r"job_tags_job.csv"), index=False)
                print()
                ...
                df_hinh_thuc.to_csv(os.path.join(self.link_to_output, r"hinh_thuc_job.csv"), index=False)
                print()
                ...
                df_ordered_cap_bac_new.to_csv(os.path.join(self.link_to_output, r"ordered_cap_bac.csv"), index=False)
                print()
            ...
            df.to_csv(os.path.join(self.link_to_output, r"jobs.csv"), index=False)
            print()
...
def main():
    link_to_data_files = r"C:\Users\Admin\Downloads\DE 2nd folder\DE project\scrape component\data cb\raw data cb\all_jobs\20230304 (Haft)"
    link_to_output = r"C:\Users\Admin\Downloads"
    ...
    sys.stdout = Logger(link_to_output)

    pipeline = Pipeline(link_to_data_files, link_to_output)
    pipeline.processing_raw_data()
